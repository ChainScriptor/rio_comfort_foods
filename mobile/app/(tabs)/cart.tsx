...
const CartScreen = () => {
  ...
  const handleProceedWithOrder = async (
    ...
    try {
      ...
      // Πρώτα καθαρίζουμε το καλάθι ώστε να εμφανιστεί η οθόνη "Το καλάθι σας είναι άδειο"
      clearCart();

      // Μικρή καθυστέρηση ώστε να προλάβει να γίνει render το άδειο καλάθι πριν εμφανιστεί το μήνυμα επιτυχίας
      setTimeout(() => {
        if (Platform.OS === "web") {
          window.alert(
            "Επιτυχής παραγγελία! Η παραγγελία σας ολοκληρώθηκε. Ο διαχειριστής θα την επεξεργαστεί σύντομα."
          );
        } else {
          Alert.alert(
            "Επιτυχία",
            "Η παραγγελία σας ολοκληρώθηκε! Ο διαχειριστής θα την επεξεργαστεί σύντομα.",
