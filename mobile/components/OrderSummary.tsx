  ...
  return (
    <View className="px-6 mt-6">
      <View className="bg-surface rounded-3xl p-5">
        <Text className="text-text-primary text-xl font-bold mb-4">Σύνοψη</Text>

        <View className="space-y-3">
          <View className="flex-row justify-between items-center">
            <Text className="text-text-secondary text-base">Υποσύνολο</Text>
          ...
          <View className="flex-row justify-between items-center">
            <Text className="text-text-secondary text-base">Μεταφορικά</Text>
            <Text className="text-text-primary font-semibold text-base">
              ${shipping.toFixed(2)}
            </Text>
          </View>
          ...
          <View className="flex-row justify-between items-center">
            <Text className="text-text-secondary text-base">ΦΠΑ</Text>
          ...
          {/* Total */}
          <View className="flex-row justify-between items-center">
            <Text className="text-text-primary font-bold text-lg">Σύνολο</Text>
